...
export const button = cva(
  ...
  ],
  {
    variants: {
      intent: {
        primary: [
          "bg-primary-10 hover:bg-primary-9 focus:bg-primary-11 hover:focus:bg-primary-11/95",
          "text-primary-3",
          "border-transparent",
        ],
        positive: [
          "bg-positive-10 hover:bg-positive-9 focus:bg-positive-11 hover:focus:bg-positive-11/95",
          "text-positive-3",
          "border-transparent",
        ],
        neutral: ["bg-neutral-2", "text-true-white", "border-white"],
        "neutral-outline": [
          "bg-true-white/0 hover:bg-true-white/5 focus:bg-true-white/100 hover:focus:bg-true-white/95",
        ...
        "ghost-neutral": [
          "bg-true-white/0 hover:bg-true-white/5 focus:bg-true-white/100",
          "text-true-white focus:text-true-black",
          "border-transparent",
          "focus:outline-none",
        ],
        "ghost-primary": [
          "bg-primary-10/0 hover:bg-primary-10/5 focus:bg-primary-10/100",
          "text-primary-10 focus:text-primary-1",
          "border-transparent",
          "focus:outline-none",
        ],
        "ghost-negative": [
          "border-transparent bg-negative-11/0 text-negative-11 hover:bg-negative-11/10 focus:border-transparent focus:bg-negative-11/100 focus:text-negative-1 focus:outline-none",
        ],
      },
      scale: {
