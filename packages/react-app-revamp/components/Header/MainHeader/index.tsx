      ...
      {isMobileOrTablet ? (
        ...
        <header className="px-10  mx-auto flex items-center justify-between mt-2 mb-4">
          ...
          <div className="flex-1 flex justify-center items-center">
            <div className="bg-true-black flex items-center gap-5 ml-[100px] text-[24px] font-bold border-2 rounded-[20px] py-[2px] px-[30px] border-primary-10 shadow-create-header">
