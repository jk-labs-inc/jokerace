...
const LandingPageExplainer = () => {
  ...
  return (
    <div
      ref={containerRef}
      className={`flex flex-col gap-8 md:gap-12 pl-4 pr-4 md:pl-16 md:pr-16 3xl:pl-28 2xl:pr-0 ${isVisible ? "animate-reveal" : "opacity-0"}`}
    >
      ...
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col gap-4 mdgap-6">
          ...
          <ul className="flex flex-col pl-8">
            ...
            <li className="text-[16px] md:text-[20px] text-neutral-11 list-disc">(optional) add rewards for winners</li>
        ...
        <Link
          ...
          className="w-[218px] h-10 bg-gradient-purple-white rounded-[40px] normal-case text-[16px] md:text-[20px] font-bold text-true-black flex items-center justify-center relative"
        >
