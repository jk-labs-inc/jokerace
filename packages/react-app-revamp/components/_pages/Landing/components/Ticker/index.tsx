...
interface LandingPageTickerProps {
  isFixed?: boolean;
}

const LandingPageTicker: FC<LandingPageTickerProps> = ({ isFixed = false }) => {
  return (
    <Ticker
      className={`bg-positive-18 h-12 flex items-center ${isFixed ? "fixed top-0 left-0 right-0 z-50" : ""}`}
      items={[
