...
const ContestRewardsInfo: FC<ContestRewardsInfoProps> = ({ rewardsModuleAddress, rewardsAbi }) => {
  ...
  const borderColor = currentReward.isReleased ? "border-positive-11" : "border-transparent";
  const textColor = currentReward.isReleased ? "text-positive-11" : "text-neutral-11";
