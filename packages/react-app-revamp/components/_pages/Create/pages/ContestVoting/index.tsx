...
const tabOptions = [
  ...
  { label: "use prefilled requirements", content: <div className="mt-7 ml-[20px]">voting req tab</div> },
];
  ...
  return (
    <div className="mt-12 lg:mt-[50px] animate-swingInLeft">
      <div className="flex flex-col lg:flex-row items-start gap-5 text-[24px]">
        ...
        <CreateTab options={tabOptions} disabledTab={1} className="w-full md:w-[650px]" />
      </div>
    </div>
  );
};
