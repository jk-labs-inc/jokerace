  ...
  return (
    <div className="flex flex-col gap-10 lg:ml-[300px] mt-24 animate-fadeIn">
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4 w-[360px] h-44 py-4 pl-4 border-neutral-9 border rounded-[10px] hover:border-neutral-11 transition-colors duration-300">
        ...
        <div className="flex flex-col gap-4 w-[360px] h-44 py-4 pl-4 border-neutral-9 border rounded-[10px] opacity-50">
