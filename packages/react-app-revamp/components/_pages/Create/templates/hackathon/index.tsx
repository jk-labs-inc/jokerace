  ...
  return (
    <div className="flex flex-col gap-4 text-true-white text-[20px]">
      ...
      <ul className="pl-8 list-disc">
        ...
        <li>
          <b>A list of judges.</b> You’ll need their wallet addresses and voting power (we <br />
          recommend 100 votes each).
        </li>
      </ul>
      <p>Don’t want to make a list? You can also allowlist tokenholders or anyone to vote.</p>
      <p>
        <b>Duration: 8 days. </b>We’ll give builders one week to submit their projects, and judges <br />
        one day to vote.
      </p>
