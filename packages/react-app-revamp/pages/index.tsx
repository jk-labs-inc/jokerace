  ...
  return (
    <>
      ...
      <div className="pl-8 pr-8 md:pl-16 md:pr-16 mt-16 md:mt-32 gap-20 md:flex md:flex-col 2xl:pl-28 2xl:pr-0 2xl:flex-row animate-fadeInLanding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 mt-12 md:mt-0 md:ml-0 items-center">
          <div>
            <div className="md:bg-[url('/explainer/bg-1.svg')] :bg-no-repeat pt-7 md:w-[520px] transform hover:scale-120 transition-transform duration-500">
            ...
            <div className="md:bg-[url('/explainer/bg-3.svg')] bg-no-repeat pt-32 md:w-[520px]  md:ml-8 transform hover:scale-120 transition-transform duration-500">
              <p className="uppercase font-sabo text-[20px] text-left md:text-center">
                proposals, <br />
                budgets, drafts, <br />
                amendments
          ...
          <div className="flex flex-col items-center gap-3 md:bg-[url('/explainer/bg-2.svg')] bg-no-repeat md:w-[600px] bg-contain pt-[120px] pl-[100px] -ml-[100px]  transform hover:scale-120 transition-transform duration-500">
            <p className="uppercase font-sabo text-[20px] text-center">
              elections,
              <br /> feature requests, <br /> pulse checks, giveaways
            </p>
            <p className="text-[15px] md:text-[16px] font-bold text-center">
