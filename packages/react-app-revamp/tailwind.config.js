  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fadeIn 1s cubic-bezier(0.39, 0.575, 0.565, 1) both",
        "fade-out": "fadeOut 2s ease-out both",
        "blink-shadow": "blink 1s ease-in-out infinite",
        "shake-top": "shakeTop 0.8s cubic-bezier(0.455, 0.030, 0.515, 0.955) both",
        "swing-in-left": "swingInLeft 0.5s cubic-bezier(0.175, 0.885, 0.320, 1.275) both",
      ...
      boxShadow: {
        ...
        "sort-proposal-dropdown": "0px 1px 6px 1px #6A6A6A;",
